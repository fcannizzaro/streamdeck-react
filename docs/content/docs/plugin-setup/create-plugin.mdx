...
Enable the devtools WebSocket server. The browser devtools UI discovers it via port scanning. Default: `false`. See [DevTools](/guides/devtools).

### `devtoolsPort`

Port for the devtools WebSocket server. If omitted, a random port in the range **39400 -- 39499** is selected automatically.
