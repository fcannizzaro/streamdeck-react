...
- **`'native-binding'`** — Uses the native Rust NAPI addon (`@takumi-rs/core`). Requires platform-specific binary packages (e.g. `@takumi-rs/core-darwin-arm64`). This is the fastest and most capable mode, supporting all font formats including WOFF/WOFF2.
