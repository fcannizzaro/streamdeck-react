...
```ts
function useTouchBarDialRotate(callback: (payload: TouchBarDialRotatePayload) => void): void;
```
...
```ts
function useTouchBarDialDown(callback: (payload: TouchBarDialPressPayload) => void): void;
```
...
```ts
function useTouchBarDialUp(callback: (payload: TouchBarDialPressPayload) => void): void;
```
