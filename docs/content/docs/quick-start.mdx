...
5. When the action appears, `@fcannizzaro/streamdeck-react` mounts a React root for that hardware instance.
6. State changes trigger re-renders, and the renderer pushes a new image to the device.
