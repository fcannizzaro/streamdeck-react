...
This guide creates a minimal counter action, bundles it, and connects it to the Stream Deck runtime. You can use either **Rollup** or **Rolldown (Vite 8)** as the bundler.
